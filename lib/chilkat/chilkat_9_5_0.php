...
class CkCrypt2 {
	...
	function HashFile($filename,$outData) {
		return CkCrypt2_HashFile($this->_cPtr,$filename,$outData);
	}
	...
	function UnlockComponent($b1) {
		return CkCrypt2_UnlockComponent($this->_cPtr,$b1);
	}
...
class CkOmaDrm {
	...
	function UnlockComponent($b1) {
		return CkOmaDrm_UnlockComponent($this->_cPtr,$b1);
	}
}
